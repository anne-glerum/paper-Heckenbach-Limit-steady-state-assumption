...
#ifndef _aspect_material_model_visco_plastic_strain_h
#define _aspect_material_model_visco_plastic_strain_h
...
namespace aspect
{
  namespace MaterialModel
  {
     ...
     */
    template<int dim>
    class PlasticStrainAdditionalOutputs : public NamedAdditionalMaterialOutputs<dim>
    {
      public:
        PlasticStrainAdditionalOutputs(const unsigned int n_points);
     ...
     */
    template <int dim>
    class ViscoPlasticStrain : public MaterialModel::Interface<dim>, public ::aspect::SimulatorAccess<dim>
    {
      public:
